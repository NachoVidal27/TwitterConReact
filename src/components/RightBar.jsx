        ...
        <div class="mt-2 py-4 px-4 bg-light rounded">
          ...
          <div class="row">
            ...
            <div class="col-7 px-3">
              <h4 class="mb-0">Hack Academy</h4>
              <h5>@HackAcademyDev</h5>
            </div>
            <div class="col-4">
              <button class="text-light rounded-pill mb-3" id="tweet-btn">
                Follow
              </button>
            </div>
          </div>
